...
public class PaylevenPaymentProcessor extends PaymentProcessor {
	...
	public PaylevenPaymentProcessor(ProceedPayment parentActivity, Payment payment) {
		super(parentActivity, payment);
        ...
        public void onPaymentFinished(String orderId,
            ...
            switch (status) {
                ...
                case WRONG_COUNTRY_CODE:
                    ...
                    break;
                case SUCCESS:
                	processor.parentActivity.registerPayment(processor.payment);
                    break;
            }
        }
